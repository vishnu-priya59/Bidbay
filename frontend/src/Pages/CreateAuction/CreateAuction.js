...
const CreateAuction = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Create Auction-BidBay</title>
      </Helmet>
...
//   const [imageUrl, setImageUrl] = useState("");
//   const [endDate, setEndDate] = useState("");
//   // const bids = [{ bidder: "null", bidAmount: 0, bidTime: Date.now }];
//   const [bidder, setBidder] = useState("");
//   const [bidAmount, setbidAmount] = useState(100);
//   const [bidTime, setBidTime] = useState(Date.now);
//   const handleSubmit = async (e) => {
//     e.preventDefault();
//     try {
//       dispatch({ type: "UPDATE_REQUEST" });
//       console.log(title, description, bidAmount, bidTime, bidder);
//       const { data } = await axios.post(
//         "/api/auctions",
//         {
//           title,
