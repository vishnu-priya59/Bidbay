            ...
            {new Date(auction.endDate).getTime() <= Date.now() ? (
              <>
                {auction.bids.length > 0 && (
                  <div className="border-b border-gray-200 py-2">
                    <p className="text-lg font-semibold">
                      ## auction.bids[auction.bids.length - 1].auction.Bidder
                      {auction.bids.Bidder === userInfo.name ? (
...
//     setBidder("");
//     setBidTime(Date.now);
//     socket.emit("bidAmount", data);
//     socket.emit("Bidder", data);
//     socket.emit("BidTime", data);
//     toast.success("Bid Placed Successfully 🎉");
//   };
...
//                   <p className="text-gray-500 text-sm">Highest Bidder</p>
//                   <p className="text-lg font-semibold">
//                     {auction.bidAmount[auction.bidAmount.length - 1].bidder}
//                   </p>
//                 </div>
//               </div>
//             )}
...
//                   <div className="border-b border-gray-200 py-2">
//                     <p className="text-lg font-semibold">
//                       {auction.bidTime[auction.bidTime.length - 1].bidder ===
//                       userInfo.name ? (
//                         <button className="w-full py-2 px-4 bg-green-500 hover:bg-green-600 text-white duration-200 rounded-md mt-4">
//                           ADD TO CART
//                         </button>
...
//               </Link>
//             )}
//             {auction.bidAmount.length > 0 && (
//               <div className="border-b border-gray-200 py-2 mt-4">
//                 <h3 className="text-lg font-bold mb-2">Bids History:</h3>
//                 {auction.bidAmount.map((bidAmount, index) => (
//                   <div key={index} className="flex justify-between mb-2">
